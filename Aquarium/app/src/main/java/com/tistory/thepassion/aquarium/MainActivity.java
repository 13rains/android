package com.tistory.thepassion.aquarium;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Toast tMsg = Toast.makeText(MainActivity.this, "토스트 텍스트", Toast.LENGTH_SHORT);
            Display display = ((WindowManager)getSystemService(WINDOW_SERVICE)).getDefaultDisplay();
            int width = (int)display.getWidth();
            int height = (int)display.getHeight();

            // toast text size 구하는 법?
            //tMsg.setGravity(Gravity.TOP|Gravity.LEFT, width/2, height/2);
            tMsg.show();
        }
